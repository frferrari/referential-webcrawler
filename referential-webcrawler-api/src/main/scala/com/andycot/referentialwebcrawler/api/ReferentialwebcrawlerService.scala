package com.andycot.referentialwebcrawler.api
...
object ReferentialwebcrawlerService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The referential-webcrawler service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the ReferentialwebcrawlerService.
  */
trait ReferentialwebcrawlerService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("referential-webcrawler")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(ReferentialwebcrawlerService.TOPIC_NAME, greetingsTopic _)
